...
ExamID int not null,
QuestionID int not null,
constraint foreign key fk_examquesiton_exams(ExamID) references exams(ExamID),
constraint foreign key fk_examquesiton_answer(QuestionID) references answer(QuestionID)
);